...
<head runat="server">
    <title>Računarski Fakultet Chat : Chat Page</title>
        ...
        $(function () {
            ...
            window.onfocus = function (event) {
                if (event.explicitOriginalTarget === window) {
                    ...
                    document.title = 'Računarski Fakultet Chat App';
                }
            }
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.messageReceived = function (userName, message, time, userimg) {
                ...
                if (CurrUser1 != userName) {
                    ...
                    IntervalVal = setInterval("ShowTitleAlert('Računarski Fakultet Chat App', '" + Notification + "')", 800);
        ...
        <div class="content-wrapper">
            ...
            <header class="main-header" style="background: #ffffff">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Računarski Fakultet</b> Chat App</span>
                </a>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary direct-chat direct-chat-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title" style="color: dimgrey;">Dobro došli u drugi projekat iz razvoja aplikacija i web servisa!</h3>
                            <div class="box-tools pull-right">
