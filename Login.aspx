...
<head runat="server">
    <title>Računarski Fakultet Chat : Login</title>
    ...
    <form id="form1" runat="server">
        <div class="login-box">
            <div class="login-logo">
                <a href="Login.aspx"><b>Računarski Fakultet </b>Chat App</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg">Ulogujte se kako bi ste mogli da koristite ovu chat aplikaciju</p>
